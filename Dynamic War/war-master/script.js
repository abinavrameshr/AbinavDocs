...
var fightButton8 = document.querySelector("#btnBattle8");
var fightButton9 = document.querySelector("#btnBattle9");
var fightButton10 = document.querySelector("#btnBattle10");
var fightButton11 = document.querySelector("#btnBattle11");
var fightButton12 = document.querySelector("#btnBattle12");
var fightButton13 = document.querySelector("#btnBattle13");
...
fightButton8.addEventListener('click', function(){
  rounds(08);
});
fightButton9.addEventListener('click', function(){
  rounds(09);
});
fightButton10.addEventListener('click', function(){
  rounds(10);
});
fightButton11.addEventListener('click', function(){
  rounds(11);
});
fightButton12.addEventListener('click', function(){
  rounds(12);
});
fightButton13.addEventListener('click', function(){
  rounds(13);
});
//FUNCTIONS
function rounds(a){
