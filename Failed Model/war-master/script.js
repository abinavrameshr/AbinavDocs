...
var war = {
  ...
  playerCard: [document.getElementById("playerCard1"),document.getElementById("playerCard2"),
  document.getElementById("playerCard3"),document.getElementById("playerCard4"),document.getElementById("playerCard5"),document.getElementById("playerCard6"),
  document.getElementById("playerCard7"),document.getElementById("playerCard8"),document.getElementById("playerCard9"),document.getElementById("playerCard10"),document.getElementById("playerCard11"),document.getElementById("playerCard12"),document.getElementById("playerCard13")],
  computerCard: [document.getElementById("computerCard1"),document.getElementById("computerCard2"),document.getElementById("computerCard3"),
  document.getElementById("computerCard4"),document.getElementById("computerCard5"),document.getElementById("computerCard6"),document.getElementById("computerCard7"),document.getElementById("computerCard8"),
  document.getElementById("computerCard9"),document.getElementById("computerCard10"),document.getElementById("computerCard11"),document.getElementById("computerCard12"),document.getElementById("computerCard13")],
  build: function() {
...
// deck.suffle is the Fisher-Yates shuffle algorithm
  ...
  deal: function() {
    ...
    for (var i=0; i<13; i++) {
      war.playerCard[i].src="cards/" + war.hand[i][0] + "_of_" + war.hand[i][1] + ".png";
  }
  for (var i=0; i<13; i++){
      war.computerCard[i].src="cards/"+ war.hand[i][0] +"_of_"+ war.hand[i][1] +".png";
  }
